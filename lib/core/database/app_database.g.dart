...
class NotesTableData extends DataClass implements Insertable<NotesTableData> {
  ...
  @override
  int get hashCode => Object.hash(id, problemId, content, updatedAt, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$NotesTableTableFilterComposer
  ...
  ColumnFilters<int> get problemId => $composableBuilder(
...
class $$NotesTableTableOrderingComposer
  ...
  ColumnOrderings<int> get problemId => $composableBuilder(
    column: $table.problemId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$NotesTableTableAnnotationComposer
  ...
  GeneratedColumn<int> get problemId =>
